...
import thailandIt from './thailandIt';
import tinclude from './tinclude';
  ...
  return (
    ...
    <div className='nav-Wallpaper-section Next-wallpaper-img'>
      ...
      <div className='nav-icon-wallpaper'>
        <div className='c-text-heading'>
         ...
         <h1 className='c-title nav-icon-page'>Thailand Tour</h1>
    ...
    <div className='Extra-support'>
      ...
      <div className='Explore-section'>
       ...
       <h1 className='Explore-heading'>Thailand Tour Package</h1>
       </div>
      ...
      <img className='andaman-img' src='https://images.unsplash.com/photo-1468774871041-fc64dd5522f3?q=80&w=1632&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' alt=''/>
      </div>
      ...
      <div className='price-tag'>
       ...
       <p className='get-quote-content-title price-basic'>Starting from</p>
       <div className='price-pax'>
       <p className='get-quote-content price-pax-sec'>₹ 20,999</p>
       <p className='get-quote-content per-person-sec'>Per Person</p>
       </div>
       </div>
      </div>
      ...
      <div className='get-quote'>
      <p className='get-quote-content-title'>Tour Details</p>
      <p className='get-quote-content'><i class="fa-solid package-icon-color fa-location-dot"></i> Destination: Thailand</p>
      ...
      <h1 className='I-heading I-heading-policy'>4Days Thailand Tour Itinerary</h1>
      </div>
      
      <div className='Itdown-section'>
      {
                    thailandIt.map(questionItem => {
                        return (
                            <Itdown
                                id={questionItem.id}
                                key={questionItem.id}
