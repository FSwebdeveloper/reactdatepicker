...
import andamanIt from './andamanIt';
import includeIt from './include';
  ...
  return (
    ...
    <div className='nav-Wallpaper-section Next-wallpaper-img'>
      ...
      <div className='nav-icon-wallpaper'>
        <div className='c-text-heading'>
         ...
         <h1 className='c-title nav-icon-page'>Andaman Tour</h1>
    ...
    <div className='Extra-support'>
      ...
      <div className='Explore-section'>
       ...
       <h1 className='Explore-heading'>Andaman Tour Package</h1>
       </div>
      ...
      <h1 className='I-heading I-heading-policy'>7Days Andaman Tour Itinerary</h1>
      </div>
      
      <div className='Itdown-section'>
      {
                    andamanIt.map(questionItem => {
                        return (
                            <Itdown
                                id={questionItem.id}
                                key={questionItem.id}
