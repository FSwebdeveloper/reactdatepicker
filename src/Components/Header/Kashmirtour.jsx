...
import kashmirIt from './kashmirIt';
  ...
  return (
    ...
    <div className='nav-Wallpaper-section Next-wallpaper-img'>
      ...
      <div className='nav-icon-wallpaper'>
        <div className='c-text-heading'>
         ...
         <h1 className='c-title nav-icon-page'>Kashmir Tour</h1>
    ...
    <div className='Extra-support'>
      ...
      <div className='Explore-section'>
       ...
       <h1 className='Explore-heading'>Kashmir Tour Package</h1>
       </div>
      ...
      <img className='andaman-img' src='https://images.unsplash.com/photo-1689961962572-988369409784?q=80&w=1559&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' alt=''/>
      </div>
      ...
      <div className='get-quote'>
      <p className='get-quote-content-title'>Tour Details</p>
      <p className='get-quote-content'><i class="fa-solid package-icon-color fa-location-dot"></i> Destination: Kashmir</p>
      ...
      <h1 className='I-heading I-heading-policy'>6Days Kashmir Tour Itinerary</h1>
      </div>
      
      <div className='Itdown-section'>
      {
                    kashmirIt.map(questionItem => {
                        return (
                            <Itdown
                                id={questionItem.id}
                                key={questionItem.id}
