...
const Packageabout = () => {
  return (
    ...
    <div className='Extra-support'>
      ...
      <div className='package-about-section'>
       <div className='package-subject'>
       <img className='package-about-img' src='./img/about.jpg' alt='about-img'/>
       </div>
       <div className='package-subject'>
        <div className='about-text'>
          <div className='about-text-content'>
            <h3 className='about-into'>About Us</h3>
            <h2 className='about-tex-heading'>We Provide Best Tour Packages In Your Budget</h2>
